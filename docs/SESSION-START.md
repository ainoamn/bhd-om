...
3. **إن كانت المهمة تتعلق بنقل ميزات من النظام القديم:** اقرأ [`docs/LEGACY-MONOLITH-INTEGRATION.md`](LEGACY-MONOLITH-INTEGRATION.md) و [`legacy/README.md`](../legacy/README.md).
4. **اقرأ الملفات المرجعية** المذكورة في القسم 2 (تفاصيل الموقع والملفات الواجب قراءتها)، و**راجع** `docs/اقرأني-الدليل-التقني-الشامل.md` عند العمل على صيانة، أو تكامل، أو ميزات تؤثر على عدة طبقات.
...
- **المنتج الرئيسي:** جذر المستودع — Next.js على [bhd-om.com](https://bhd-om.com).
- **المرجع القديم:** `legacy/bhd-real-estate/` — monolith من `C:\dev\عقود الايجار` (دمج تدريجي، لا يُنشر منفصلاً).
