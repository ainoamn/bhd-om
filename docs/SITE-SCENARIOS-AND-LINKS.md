...
| `/[locale]/portal/tenant/v2` | بوابة المستأجر (عقود، مستحقات، مهام، تنبيهات، تقييم) | افتراضي لدور CLIENT بعد الدخول |
| `/[locale]/portal/owner/v2` | بوابة المالك (مباني، مستأجرين، إيرادات، مصاريف) | افتراضي لدور OWNER/LANDLORD |
