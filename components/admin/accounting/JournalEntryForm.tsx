  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <button
        ...
        className="admin-accent-text hover:admin-accent-text text-sm font-medium flex items-center gap-2"
      >
      ...
      <div className="flex gap-4">
        <button
          ...
          className="admin-btn-primary text-white px-6 py-2 rounded hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
        >
