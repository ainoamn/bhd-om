/**
 * صفحة إلغاء الدفع — Server Component (بدون onClick)
 */
  ...
  return (
    <main className="min-h-screen bg-gray-50 flex items-center justify-center p-4" dir="rtl">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg overflow-hidden text-center">
        ...
        <div className="p-8">
          <h1 className="text-2xl font-bold text-gray-800 mb-2">تم إلغاء العملية</h1>
          ...
          <div className="space-y-3">
            ...
            <Link
              href="/ar/portal/tenant/v2"
              prefetch
              className="inline-block w-full px-6 py-3 border border-gray-300 text-gray-700 font-bold rounded-lg hover:bg-gray-50 transition-colors"
            >
              المحاولة مرة أخرى
            </Link>
          </div>
