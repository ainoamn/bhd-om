...
export default function ScanUserPage() {
        ...
        <div className="w-full max-w-xl mx-auto">
          <div className="rounded-3xl border border-gray-200/70 bg-white shadow-xl overflow-hidden">
            <div className="px-6 py-6 bg-[#8B6F47] text-white">
              <p className="text-xs font-semibold opacity-90 uppercase tracking-wide">{ar ? 'بطاقة المستخدم' : 'User card'}</p>
              <h1 className="text-xl font-bold mt-2">{ar ? 'تعذر عرض البيانات' : 'Unable to display'}</h1>
            </div>
            <div className="p-6">
              <div className="rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-red-900 font-semibold">{error}</div>
  ...
  return (
    <div className="w-full bg-gradient-to-b from-[#f7f3ee] via-gray-50 to-white px-2 sm:px-4 lg:px-6 py-6 sm:py-10" dir={dir}>
      <div className="w-full max-w-4xl mx-auto">
        <div className="w-full rounded-3xl border border-gray-200/70 bg-white shadow-xl overflow-hidden">
          {/* رأس الموقع — نفس أسلوب البطاقة السابقة */}
          <div className="relative overflow-hidden bg-[#8B6F47] text-white">
            ...
            <div className="relative px-6 py-7">
              ...
              <div className="mt-2 flex items-center gap-4">
                <div className="h-14 w-14 rounded-2xl bg-white/15 border border-white/20 flex items-center justify-center font-extrabold text-lg shrink-0">
                  {initials}
                </div>
              ...
              <p className="text-sm opacity-90 mt-4 break-words">{displaySummary}</p>
            </div>
          </div>
